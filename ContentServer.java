...
public class ContentServer {
    ...
    public static void sendPutRequest(PrintWriter out, String filename) {
        ...
        try {
            ...
            InputStream fstream = ClassLoader.getSystemClassLoader()
                    .getResourceAsStream("manualTestingTxtFile/" + filename);
    ...
    // This method appear as a way to maintain connection with the server, since we
    // have dicussed in the lecture that we can
    // end the content server connection to server
    public static void persistentConnection(BufferedReader in, PrintWriter out, String hostName, String fileName) {
        ...
        while (running) {
            ...
            System.out.println("Press Enter to send PUT request");
            sc.nextLine();
